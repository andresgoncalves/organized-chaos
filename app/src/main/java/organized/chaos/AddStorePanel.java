...
public class AddStorePanel extends javax.swing.JPanel {
    ...
    public void updateStatus() {
        if(nameTextField.getText().isBlank()) {
            statusLabel.setText("Ingrese un nombre para el almac�n");
        ...
        if(current != null && current != store ) {
            statusLabel.setText("El almac�n ya existe");
            statusLabel.setVisible(true);
            saveButton.setEnabled(false);
        }
        else if(routes.getSize() < 2) {
            statusLabel.setText("Agregue al menos 2 rutas al almac�n");
            statusLabel.setVisible(true);
            saveButton.setEnabled(false);
        }
        else {
    ...
    private void searchButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchButtonActionPerformed
        ...
        if(store != null) {
            ...
            JOptionPane.showMessageDialog(this, "No se encontr� el almac�n", "Error", JOptionPane.WARNING_MESSAGE);
        }
