...
public class BuyPanel extends javax.swing.JPanel {
    ...
    public void updateStatus() {
        if(((String) nameComboBox.getSelectedItem()).isBlank()) {
            statusLabel.setText("Seleccione un almac�n");
    ...
    private void buyButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buyButtonActionPerformed
        ...
        if(borrowList.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "La compra se proces� exitosamente", "Operaci�n exitosa", JOptionPane.INFORMATION_MESSAGE);
        App.getInstance().showOptionsPanel();
            ...
            App.getInstance().saveFile();
            JOptionPane.showMessageDialog(this, "La compra se proces� exitosamente abasteciendo desde el Almac�n %s, a una distancia de %d km".formatted(borrowStore.getName(), borrowPath.getLast().getValue().getDistance()), "Operaci�n exitosa", JOptionPane.INFORMATION_MESSAGE);
